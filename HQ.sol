...
contract HQ is Ownable {
    ...
    function guess(string memory _question, string memory _answer) public notOwner {
        require(_quiz[_question].answer == keccak256(abi.encodePacked(_answer)), "Sorry your answer was incorrect");
    ...
    function withdraw() external notOwner {
